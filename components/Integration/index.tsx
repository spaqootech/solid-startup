      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Availablity`,
              subtitle: `Spaqoo Tech provide service, From Anywhere, Anytime.`,
              description: `Spaqoo Tech ensures that you can access our services from anywhere, anytime. We are available 24/7 to provide you with the best service.`,
          }}
          />
